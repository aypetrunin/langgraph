"""HTTP-клиент для сохранения диалогов через httpservice.ai2b.pro.

Отправляет финальный ответ агента (текст, инструменты, токены, состояние диалога)
на внешний endpoint для сохранения в историю и аналитику.

Ретраи при сетевых ошибках обеспечиваются декоратором @retry_async из zena_common.
"""
